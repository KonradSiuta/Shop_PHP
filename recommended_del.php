...
?>
    <section class="main container-fluid p-1 mt-1">
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <h1>Usuwanie produktu z polecanych</h1>

                <form action="recommend_del_exec.php" method="post">
                    ...
                    <button class="btn btn-success mt-2" type="submit">Usuń produkt z polecanych</button>
                </form>
            </div>
        </div>
    </section>
