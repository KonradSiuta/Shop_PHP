...
?>
    <section class="main container-fluid p-1 mt-1">
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <h1>Dodawanie produktu do polecanych</h1>

                <form action="recommend_add_exec.php" method="post">
                    ...
                    <button class="btn btn-success mt-2" type="submit">Dodaj produkt do polecanych</button>
                </form>
            </div>
        </div>
    </section>
