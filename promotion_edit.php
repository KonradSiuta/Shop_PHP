    ...
    <section class="main container-fluid p-1 mt-1">
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <form action="promotion_edit_exec.php" method="post">
                    ...
                    <label for="prod_cena" class="form-label mt-1">Podaj cenę promocyjną</label>
                    ...
                    <button class="btn btn-success mt-2" type="submit">Zmień produkt</button>
                </form>
            </div>
        </div>
    </section>
